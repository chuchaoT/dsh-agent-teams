...
export const zh = {
  ...
  'team.stats.telemetry': '遥测',
  'task.approval.pending': '等待人工审批',
  'task.approval.approve': '批准',
  'task.approval.reject': '拒绝',
  'task.approval.failed': '审批失败：{message}',
  'task.detail.evidence': '证据',
  'task.detail.artifacts': '产物',
...
export const en = {
  ...
  'team.stats.telemetry': 'telemetry',
  'task.approval.pending': 'Awaiting human approval',
  'task.approval.approve': 'Approve',
  'task.approval.reject': 'Reject',
  'task.approval.failed': 'Approval failed: {message}',
  'task.detail.evidence': 'Evidence',
